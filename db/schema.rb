...
ActiveRecord::Schema[7.0].define(version: 2023_04_02_154818) do
  ...
  create_table "budgets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "ready_to_budget_cents", default: 0, null: false
    t.string "ready_to_budget_currency", default: "EUR", null: false
  end
