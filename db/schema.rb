...
ActiveRecord::Schema[7.0].define(version: 2023_08_15_205057) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.bigint "budget_id"
    t.integer "reported_balance_cents", default: 0, null: false
    t.string "reported_balance_currency", default: "EUR", null: false
